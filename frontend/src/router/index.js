...
const router = createRouter({
  ...
  routes: [
    ...
    //----- Vistas de Reportes -----
    {
      ...
      component: () =>
        import("../views/ResportesViews/PaseosProgramadosView.vue"),
    },
    {
      path: "/historialPaseos",
      name: "historialPaseos",
      component: () =>
        import("../views/ResportesViews/HistorialPaseosView.vue"),
    },
    //-----------------------------
    ...
    //----- Vistas de Disponibilidad Paseador -----
    {
      ...
      component: () =>
        import(
          "../views/DisponibilidadPaseadorViews/DisponibilidadPaseadorView.vue"
        ),
    },
    {
      ...
      component: () =>
        import(
          "../views/DisponibilidadPaseadorViews/CargarDisposPaseadorView.vue"
        ),
    },
    //-----------------------------
    ...
    //----- Vistas de Contratacion -----
    {
      ...
      component: () =>
        import("../views/ContratarPaseoViews/BusquedaPaseadoresView.vue"),
    },
    {
      path: "/contratarPaseador",
      name: "contratarPaseador",
      component: () =>
        import("../views/ContratarPaseoViews/ContratarPaseadorView.vue"),
    },
  ],
});
