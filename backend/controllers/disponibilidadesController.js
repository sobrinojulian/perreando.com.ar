...
class ControllerDisponibilidad {
    ...
    filtrarPaseadores = async (req, res) => {
        try{
            ...
            console.log('Error en ControllerDisponibilidad.filtrarPaseadores() --> ', error)
        }
    }
    ...
    obtenerDisponibilidadesByPaseador = async (req, res) => {
        try{
            ...
            const paseadores = await this.service.obtenerDisponibilidadesByPaseador(paseadorId)            
            res.json(paseadores)
        }catch(error){
            console.log('Error en ControllerDisponibilidad.obtenerDisponibilidadesByPaseador() --> ', error)
        }
    }
    ...
    eliminarDisponibilidad = async (req, res) => {
        try{
            ...
            console.log('Error en ControllerDisponibilidad.eliminarDisponibilidad() --> ', error)
        }
    }
    ...
    cargarDisponibilidades = async (req, res) => {
        try{
            ...
            console.log('Error en ControllerDisponibilidad.cargarDisponibilidades() --> ', error)
        }
    }
