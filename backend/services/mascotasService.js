...
class ServiceMascota {
  ...
  obtenerMascotasByOwner = async ownerId => {
    try {
      ...
      console.log(
        'Error en ServiceMascota.obtenerMascotasByOwner() --> ',
        error
      )
      return []
    }
  ...
  guardarMascota = async mascota => {
    try {
      ...
      if (validate.respuesta) {
        ...
        mensajeError =
          'Error al guardar la mascota, valide los datos ingresados.'
  ...
  actualizarMascota = async (id, mascota) => {
    try {
      ...
      if (validate.respuesta) {
        const mascotaUpdated = await this.modelMascota.actualizarMascota(
          id,
          MascotaA
        )
        ...
        mensajeError =
          'Error al actualizar la mascota, valide los datos ingresados.'
        console.log(mensajeError)
        return { respuesta: validate.respuesta, error: mensajeError }
      }
    } catch (error) {
